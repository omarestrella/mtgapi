...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Card.power'
        raise RuntimeError("Cannot reverse this migration. 'Card.power' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Card.power'
        db.alter_column(u'mtgapp_card', 'power', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # User chose to not deal with backwards NULL issues for 'Card.toughness'
        raise RuntimeError("Cannot reverse this migration. 'Card.toughness' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Card.toughness'
        db.alter_column(u'mtgapp_card', 'toughness', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
