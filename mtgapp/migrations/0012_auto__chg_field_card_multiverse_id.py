...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mtgapp_card', 'multiverse_id', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Card.multiverse_id'
        db.alter_column(u'mtgapp_card', 'multiverse_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
